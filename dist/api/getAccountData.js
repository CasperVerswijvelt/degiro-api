...
function getAccountDataRequest(_a) {
    var accountConfig = _a.accountConfig, userAgent = _a.userAgent;
    return new Promise(function (resolve, reject) {
        ...
        utils_1.fetch(accountConfig.data.paUrl + "client?sessionId=" + accountConfig.data.sessionId, requestOptions, userAgent)
